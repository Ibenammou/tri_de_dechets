...
def main(_):
    # Set the image directory directly (replace 'YOUR_IMAGE_DIRECTORY' with the actual path)
    FLAGS.image_dir = 'C:\\Users\\Windownet\\Desktop\\waste segregation\\santa\\plastic_waste'
